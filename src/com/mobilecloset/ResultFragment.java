...
public class ResultFragment extends ParentFragment implements OnClickListener
{
	  // JSON Node names
    public static final String TAG_SUCCESS = "success";
    private static String url_search = "http://bryanching.net/mcloset/search.php";
...
//    m_vwClosetLayout = (LinearLayout) view.findViewById(R.id.closetLayout);
    ...
    new ClosetURLs().execute(getActivity().getIntent().getExtras().getString("query"));
      ...
      imageLoader.displayImage(images[position], imageView, options,
          new SimpleImageLoadingListener()
          {
                ...
                FailReason failReason)
            {
              ...
              Toast.makeText(ResultFragment.this.getActivity(), message,
  ...
  public class ClosetURLs extends AsyncTask<String, Void, String>
  {
    ...
    protected void onPostExecute(String jo)
    {
      ...
      try
      {
    	  ...
    	  int success =jaz.getInt(TAG_SUCCESS);
    	  if(success==1)
    	  {
