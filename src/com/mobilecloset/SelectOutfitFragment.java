...
public class SelectOutfitFragment extends ParentFragment implements
    OnClickListener
{
      ...
      Bundle savedInstanceState)
  {
    ...
    outfit = getActivity().getIntent().getParcelableExtra("outfit");
    selectedClothing = getActivity().getIntent().getParcelableExtra("clothing");
  ...
  public boolean onOptionsItemSelected(MenuItem item)
  {
    ...
    case android.R.id.home:
      ...
      //
      outfit.addClothing(selectedClothing);
      return true;
    }
  ...
  public void onClick(View v)
  {
    ...
    case R.id.closet:
      ...
      intent.setClass(getActivity(), GenericActivity.class)
          .putExtra("fragment", SelectOutfitFragment.class.getName())
          .putExtra("clothing", selectedClothing);
      ...
      imageLoader.displayImage(clothing.get(position).url, imageView, options,
          new SimpleImageLoadingListener()
          {
                ...
                FailReason failReason)
            {
              ...
              Toast.makeText(SelectOutfitFragment.this.getActivity(), message,
